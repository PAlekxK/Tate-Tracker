...
| **calibration** | `cPerson` ported (her text size), `cEdge: null`, and a **grant-level `contributorLoop: false`** | Per `../fernwood-private/.plans/2026-09-02-data-model-design.md` §2c. See the sub-finding below — the declaration alone does not close it. |
