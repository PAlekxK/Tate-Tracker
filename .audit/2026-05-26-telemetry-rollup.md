...
2. **Strong candidate signal that the most-active iPhone is Mom.** `d-‹p-7f3a2c›` — viewport 393x793 (iPhone Pro), 12 `text_size_changed` events (the only device that used the A/A+ toggle Paul shipped 5/22 for Mom-without-glasses), heavy `entry_revisited` (55) suggesting return-visits to saved notes, 2 Garden Guru conversations + 1 species promoted. **Confirm by asking Mom or comparing UA + Safari history.** If confirmed, this is the load-bearing answer to the eval rubric's primary question: *"The dashboard gets opened regularly."* ✓
