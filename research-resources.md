...
### Family email archive — Tate Mountain community record (2010–2026) 🏠 primary source
**Location:** iCloud `Archive/Tate Mountain — AHR Association & Community (2010-2026, both Gmails) 2026-07/` (515 messages + 200 attachments, year-foldered with INDEX.md; extracted 2026-07-22 from the Google-Takeout mail corpus).
**What it is:** The family's own primary-source record of life inside Tate Mountain Estates — Paul's family has been part of the Tate community his whole life (Paul, 2026-07-22), and Fernwood is the family's house within it. Includes Tate Mountain Corporation board-meeting minutes (2020-21), annual-meeting agendas/minutes, the member directory work (Mom contributed as far back as 2011), the Johnston boundary issue (2021), the Silt Pond update, the Poetry of Tate booklet, Tate Dam Road Race, membership threads, and community correspondence back to 2010 ("Hallo aus Tate!", "Friends at Tate").
**Why it's relevant here:** Every other source in this category is *about* Tate; this one is the family *in* Tate — the lived-membership layer that connects the Sam Tate history to the Property card's present. TMC minutes are also the community's own governance record (roads, dam, pond, boundaries) — the authoritative source for community-infrastructure facts near the property.
**Dashboard integration idea:** Property-card "our Tate story" narrative thread (family membership arc → the house); TMC-minutes facts can ground community-infrastructure references (dam, silt pond, roads). Curate person-level details deliberately — this is a public repo; the archive itself stays in iCloud.
**Depth tier:** Foundation source (private archive; reference by pointer, not by copying content in).
