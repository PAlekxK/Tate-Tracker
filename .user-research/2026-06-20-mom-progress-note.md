...
**On the interview** — I gave it another small refresh, just a few more questions about how you use it day to day. Everything else is the same as before. Because I changed a little, I'm pasting the **updated version** below, so you've got the current one in one place.
...
If she reaches a point where she'd have an answer, follow with — and then go quiet:
> *"Say it tells you what it is. Then what — is there anything you'd want to do with that, or are you just glad to know?"*

Do not suggest anything she could do, and do not name any button or feature. You are listening for whether *doing something with it* — saving it, adding it, keeping it — is a move she reaches for on her own, and whether she got there by showing it a photo or by asking in words.
...
**Two paired questions about finding a new plant (ask both, separately — only if this didn't already come up in Scenario B):**
Ask them apart, and wait after each. The first is about using a photo; the second is about just asking in words. Keep them distinct — don't let an answer to one stand in for the other.
- *"Tell me about a time you took a photo of something on the property to figure out what it was. Once you knew what it was, what did you do next?"*
- *"Now tell me about a time you just asked — in words, no picture — about a plant, and it turned out to be something not already in your app. Did you want to do anything with it, or were you happy just knowing the answer?"*
