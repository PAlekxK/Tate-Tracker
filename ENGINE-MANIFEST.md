...
```json manifest
{
  ...
  "dirs": {
    ...
    "estate/":           {"class": "engine",   "tier": "MUST-NOT-DIVERGE", "tier_by": "agent-proposed 2026-09-10 (lap 7 P3); Paul assigns", "note": "the household's front page — who is signed in, the place, the shelf link; reads what onboarding/ declares, never a place name in its bytes"},
    "homes/":            {"class": "engine",   "tier": "MUST-NOT-DIVERGE", "tier_by": "agent-proposed 2026-09-10 (lap 7 P3); Paul assigns", "note": "the shelf — every home an account can open; same neutrality rule as onboarding/"},
    "settings/":         {"class": "engine",   "tier": "MUST-NOT-DIVERGE", "tier_by": "agent-proposed 2026-09-10 (lap 7 P3); Paul assigns", "note": "account/ and place/ — the person's and the place's editable record; same neutrality rule as onboarding/"},
