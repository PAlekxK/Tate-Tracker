# Fernwood — pickup-point log archive

Historical, point-in-time session trail moved out of `CLAUDE.md` 2026-07-17 to keep it lean. **This is history, not status** — current status lives in `BACKLOG.md`. Git holds the full record either way.
...
# Historical roadmap — Forward direction (Phases D/E/F/G)

Moved out of `CLAUDE.md` 2026-07-17. D/E/F shipped; G is DEFERRED in `BACKLOG.md`. Kept for the design detail (Phase-G / plants-to-consider / property-map direction notes).
