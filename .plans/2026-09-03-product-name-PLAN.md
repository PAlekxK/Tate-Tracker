...
- ready: agent-proposed 2026-09-03 — Paul rules. ~~⛔ **AWAITING PAUL — now a LAP-8 PREREQUISITE**~~ ✅ **Q3 RULED 2026-09-11 ~3:05 AM ET — "My Home Place", Home emphasized (see the stage-note); the lap-8 prerequisite is met.** Was: `[paul-ruled 2026-09-11 ~12:10 AM ET, laps 8/9 scope walk, 8·4: "rule the product name BEFORE B" — a link Mom receives is not renamed under her; CYCLE-LOG `767242c`]`. The migration of her account row into the production origin (lap 8 · B) waits on this ruling.
- stage: ready
- stage-note: 2026-09-11 ~12:20 AM ET — AWAITING flag added by the backlog-refinement window on the 8·4 ruling; body untouched.
- stage-note: 2026-09-11 ~12:40 AM ET — **the ADDRESS half of 8·4 is RULED**: *"we got the domain myhome.place, right? We should use that."* `[paul-ruled]` — the production origin's address is the apex `myhome.place` (TIER 1 · 46; lap 8 · B). ⚠️ **Q3 (the product's NAME — My Home · a distinct word · no name) is still his**, and Q2/Q2b's family-door level (`kirschenbauer.myhome.place`) reads as retired by `VOCABULARY.md` §3i's one origin plus this ruling — the apex IS the door; his one word confirms or reverses that reading. The AWAITING flag stays for Q3. **Q2/Q2b's family-door level is now RETIRED** `[paul-ruled 2026-09-11 ~1:45 AM ET, item 8 of the nine]` — the apex is the one door; the reading is confirmed, not only proposed.
- stage-note: 2026-09-11 ~2:40 AM ET — **Q3, a STARTING name proposed by Paul, voice-dictated, verbatim:** *"can we just start by calling it either a state manager or my home place estate manager"* (read: *Estate Manager* · *My Home Place Estate Manager*) `[paul-stated — a proposal, not a ruling]`. ⚠️ **Collision, put to him:** `VOCABULARY.md` §4 rejects *"estate manager"* by name (`[paul-ratified 2026-09-02]`: *"Manager" is task-board vocabulary the tone rule forbids; a name that describes a management function over someone's home names the reader as an operator of their own life*) and §1 rules *estate never reaches a user-facing surface*; §3f keeps *"the estate manager master loop"* as his own term for the **administrator's back end**. Paul: *"I'm definitely open to the content steward weighing in on this."* → content-steward commissioned, trail `.content-reviews/2026-09-11-product-name-starting-name.md` (it recommended keeping *My Home*, already shipped, and giving *Estate Manager* to the back end).
- stage-note: 2026-09-11 ~3:05 AM ET — ✅ **Q3 RULED — THE STARTING NAME IS "My Home Place", with HOME emphasized** `[paul-ruled, voice-dictated, verbatim: "Let's just go with my home place for now and bold home in between my and place or something. To just emphasize home, that'll make everything coherent when we kinda move to my home dot place."]`. Read as: the wordmark **My *Home* Place** (a `<title>` carries no emphasis — `My Home Place`; the `<h1>` carries the emphasis on *Home*); said aloud *"my home dot place"*; **"for now"** = a starting name with a planned revisit, not a brand ruling. **The rule the steward wrote rides with it, unchanged:** the name shows only until a person names their place; their word wins. **"Estate Manager" is the administrator's back end only** (§3f), never a person's surface; *"My Home Place Estate Manager"* never. Departs from the steward's recommendation on the one point that is a preference question (his), and keeps its structure. **Surfaces to change, build side (lap 8, with the apex page):** `onboarding/index.html:7,:304` · `estate/index.html:7,:172` · `homes/index.html:270` fallback · `VOCABULARY.md` §3b's top-bar third term · the apex page (C4 2a′). The steward's falsifier stands: if he keeps appending a descriptor aloud, a sentence is missing under the name. **The lap-8 · B prerequisite (8·4) is MET** — the link Mom receives carries this name.
- stage-note: 2026-09-11 ~3:05 AM ET — with Q1 (the address, 09-03), Q2/Q2b (retired) and Q3 (ruled) all answered, this plan's own header can take his stamp; **the stamp is his, not written here.**
- stage-note: 2026-09-11 ~3:15 AM ET — the vocabulary side carried by the coordination window at `78f68a7`: `VOCABULARY.md` §3b's top-bar third term now reads *My Home Place* with his words and the three rules; the lap-8 build plan carries a stage-note that row B's name gate is MET and lists the string sites for re-audit at open; `check-vocabulary.py` clean.
