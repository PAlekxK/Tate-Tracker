...
> ## ⛔ STATUS: **PROPOSAL.** Nothing is locked. Paul asked for this *"before we lock it all in."*
> On his ruling it promotes to `VOCABULARY.md` at the repo root. Terms already ratified are marked
> as such and are **not** re-proposed — they are recorded so one document holds the whole set.
