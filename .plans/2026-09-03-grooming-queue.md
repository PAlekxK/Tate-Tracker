...
|---|---|---|---|---|---|---|---|---|
| 0 | Environments + repo structure + rename | C4 | O3 | engine · must-not-diverge | ran: practice-steward · engineering-partner | ai-advisor · ux-expert · content-steward (no model, nothing she sees, no copy) | — | **plan drafting** |
