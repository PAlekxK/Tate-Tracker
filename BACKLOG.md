...
| source | finding |
|---|---|
| Paul, production `fb-gu2zv3t9` | formatting off; **no left border** on the card *(disposed `act` → UX/design theme)* |
