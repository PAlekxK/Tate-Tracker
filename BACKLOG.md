...
→ READY · .plans/2026-09-03-c7-condo-paper-model-PLAN.md — ✅ **STAMPED `[paul-approved 2026-09-03]`** — she OWNS the condo; MINIMAL form (weather · household · place-minimal on; garden · machines off); frost = a three-layer derivation, engine-wide. Four questions wait at their named steps. The build-out is **C8**, below. Step 0 — the null-guard pass at Fernwood — is buildable now and pays on its own. Not stamped.
