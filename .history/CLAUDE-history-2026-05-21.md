# CLAUDE.md history snapshot — 2026-05-21

Sections archived from `CLAUDE.md` during the W1a audit trim (per `.audit/bloat-punch-list-2026-05-21.md`). All entries are either struck-through-done or superseded; they live here for archaeological reference, not as load-bearing context.
