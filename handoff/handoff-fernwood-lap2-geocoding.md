...
4. **State & pointers**
   ...
   - **In flight, not landed:** a practice-steward run (design mode) writing `.plans/2026-09-07-feedback-consolidation-lap2-PRACTICE.md` — how production feedback is swept, labelled and consolidated (Paul's rulings 12:10–12:15 ET in CYCLE-LOG). If the file exists when you start, read its ten-line summary and relay it; if not, it was lost with the old window — re-run from the CYCLE-LOG brief.
