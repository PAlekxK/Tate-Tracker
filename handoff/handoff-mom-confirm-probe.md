...
- **Naming — Paul steered it (2026-07-13, supersedes the content-steward's "When you're out there"):** center the framing on *Mom* — leaning **"Mama's Perspective"** (or "Mom's Perspective"). Resolve the one nuance with Paul before finalizing copy: the label shows on Mom's own device, so decide whether it speaks **to her** (2nd person) or **names her contribution** (3rd-person "Mama's Perspective," warm family-journal register). Content-steward does the final voice pass on the chosen direction; keep the Paul-attributed uncertainty framing + the three honest branches regardless.
